...
Generated by Hoffer Studios AI Assistant
    ...
    if (!process.env.SENDGRID_API_KEY) {
      console.log('=== NEW LEAD EMAIL (No SendGrid API Key) ===');
      ...
      return {
        ...
        body: JSON.stringify({ 
          success: true, 
          message: 'Lead processed successfully (logged to console - no SendGrid API key)',
          emailSubject,
          emailBody
        })
      };
    ...
    // Import SendGrid dynamically (ES modules)
    const sgMail = await import('@sendgrid/mail');
    sgMail.default.setApiKey(process.env.SENDGRID_API_KEY);
    
    const msg = {
      to: 'info@hofferstudios.com',
      from: 'noreply@hofferstudios.com', // Make sure this is verified in SendGrid
